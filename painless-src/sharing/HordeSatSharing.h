...
public:
   ...
   void print_duplicate(string end_file,string end_file_selected);
protected:
   ...
   /// Used to Count doublons before selection
   ClauseHashTable stats_doublons;
   /// Used to Count doublons after selection
   ClauseHashTable stats_doublons_selected;
   /// L'interval de l'échantillon
   static double interval;
   /// Savoir l'interval actuelle
   static double current_interval;
   /// Savoir le round actuel

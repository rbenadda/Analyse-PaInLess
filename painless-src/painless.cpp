...
int main(int argc, char ** argv)
{
   ...
   int cpus = Parameters::getIntParam("c", 28);
   string solverName = Parameters::getParam("solver","m");
   ...
   sharers[0]->sharingStrategy->print_duplicate("-w_dup","-w_dup_selected"); // Before and after
